/**
 * diagnostics.js — Metrics comparison chart, bar charts
 */
        ...
        container.querySelectorAll('.js-grouped-bar-chart').forEach(function (canvas) {
            ...
            var datasets = datasetsRaw.map(function (ds, i) {
                return {
                    label: ds.label,
                    data: ds.data,
                    backgroundColor: alpha(palette[i % palette.length], 0.7),
