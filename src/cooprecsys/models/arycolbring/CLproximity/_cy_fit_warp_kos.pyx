...
from cooprecsys.models.arycolbring.CLproximity._cy_math           cimport (sample_range, in_positives,
...
from cooprecsys.models.arycolbring.CLproximity._cy_regularize     cimport regularize, locked_regularize, omp_lock_t, omp_init_lock, omp_destroy_lock
